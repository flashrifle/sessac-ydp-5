...
let mathScore = 77;
let engScore = 88;
let agvScore = (Number(mathScore) + Number(engScore)) / 2;
console.log(agvScore, typeof agvScore);

// +) null, undefined를 숫자로 바꾼다면?
console.log(Number(undefined), typeof Number(undefined)); // NaN : Not-a-Number 숫자가 아임.
